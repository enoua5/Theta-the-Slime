function pause()
{
	...
	screen.innerHTML+="<h3 style='color: white;'>music: </h3><input type='range' id='myRange' value='"+localStorage.getItem("e5_googame_music_volume")+"' min='0' max='1' step='0.01' onchange='localStorage.setItem(\"e5_googame_music_volume\",this.value); updateMusic();'>";
	screen.innerHTML+="<h3 style='color: white;'>sfx: </h3><input type='range' id='myRange' value='"+localStorage.getItem("e5_googame_sfx_volume")+"' min='0' max='1' step='0.01' onchange='localStorage.setItem(\"e5_googame_sfx_volume\",this.value); updateSfx();'>";
